...
from config import bot_token, secret, log_channel, admin_channel, tba_key, team, match_scouts, match_scouting_shifts, events_to_scout, announcement_channel
...
def send_schedule(scout_id):
    ...
    blocks = bkt.match_scouting_schedule(shift_str)
